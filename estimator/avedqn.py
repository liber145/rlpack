...
class AveDQN(TFEstimator):
    ...
    def _get_update_target_op(self):
        ...
        for i in range(self.k, 0, -1):
            with tf.control_dependencies(update_ops):
                ...
                logger.info("params1 : {}".format(params1))
    ...
    def update(self, trajectories):
        ...
        for i in range(int(np.ceil(n_sample / batch_size))):
            ...
            targets = reward_batch[span_index] + (
                1 - done_batch[span_index]) * self.discount * target_next_q_vals_best
    ...
    def _update_target(self):
        print("update target op:", self.update_target_op)
